...
pub const STEP_CODING_AGENT: &str = "agents.coding_agent";
...
impl FromStr for CodingAgentSelection {
    type Err = String;
...
fn resolve_claude_config_dir(mode: RuntimeMode) -> Result<PathBuf> {
...
mod tests {
    ...
    #[test]
    fn onboarding_ends_with_agent_preferences_then_archetype() {
        assert_eq!(
            &CURRENT_ONBOARDING_STEPS[CURRENT_ONBOARDING_STEPS.len() - 3..],
            [STEP_CODING_AGENT, STEP_EXERCISE_PREFERENCES, STEP_ARCHETYPE,]
        );
    }
